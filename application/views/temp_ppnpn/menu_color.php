<div id="menu-highlights" class="menu menu-box-bottom menu-box-detached rounded-m"   data-menu-height="510" data-menu-effect="menu-over" style="display: block; height: 510px;"><div class="card header-card shape-rounded h-40">
<div class="card-overlay bg-highlight opacity-95"></div>
<div class="card-bg preload-img" data-src="<?php echo base_url()?>mobile/images/pictures/20s.jpg"></div>
</div>
<h1 class="text-center color-white mt-4 font-15 font-800">THEMA APLIKASI</h1>
 <br><br>
