...
<html lang="en">
	...
	<body class="main-body  app">
        ...
        ?>
	<?php
	if(strtoupper($this->session->level)=="PIC_COVID"){?>
	<script>
		function notifPIC(){
		var url   = "<?php echo site_url("pic/notif");?>";
							...
							$.ajax({
									...
									success: function(val){
										...
										notif=val['notif'];
										if(notif==true){
										$("#mdl_notif").modal({backdrop: 'static', keyboard: false});
										 $("#isin").html(val['data']);
										}
									}
							});	
...
setTimeout(() => {
	...
	<div class="modal effect-newspaper" id="mdl_notif" style="z-index:1500" role="dialog">
