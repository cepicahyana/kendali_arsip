...
if($level=="admin"){
    ...
    $dp = $this->db->get_where("tm_pic",array("id"=>$this->session->userdata("id")))->row();
        ...
        <?php } ?>
					<div class="container">
						<div class="main-header-left ">
							...
							<i class="fa fa-chart-pie sadow" style="font-size:25px;color:#FFFF00"></i> KENDALI COVID </div>
								<img src="<?php echo base_url()?>assets/img/brand/logo.png" class="logo-default">
								<div class="icon-white" style="color:white;margin-top:20px;font-size:16px;font-weight:bold"> KENDALI COVID </div>
								...
								<div class="dropdown main-profile-menu nav nav-item nav-link">
									...
									<div class="dropdown-menu">
										<div class="main-header-profile header-img">
											...
											<h6><?php echo $nama_pengguna;?></h6><span><?php echo $this->m_reff->area();?></span>
										</div>
