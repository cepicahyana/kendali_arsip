		...
		<h4 style="margin-left:20px;color:black" class='  feather icon-home'> <?php echo strip_tags($agenda);?></h4>
                ...
                <div class="card" style='opacity:0.9' >
                    <div class="card-body">
                        <div class="row align-items-center m-l-0">
                            ...
                            <div class="col-auto">
                                <h6 class="text-muted m-b-10">TOTAL UNDANGAN</h6>
                ...
                <div class="card " style='opacity:0.9'>
                    <div class="card-body">
                        <div class="row align-items-center m-l-0">
                            ...
                            <div class="col-auto">
                                <h6 class="text-muted m-b-10">TELAH HADIR</h6>
                        ...
                        <div class="row align-items-center m-l-0">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="custom-control custom-radio custom-control-inline">
                                    ...
                                    <label class="custom-control-label" for="customRadioInline1">Telah hadir</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input onclick='reload_table()' type="radio" id="customRadioInline2" name="status" value='2' class="custom-control-input">
                                    <label class="custom-control-label" for="customRadioInline2">Belum hadir</label>
                                </div>
								<div class="custom-control custom-radio custom-control-inline">
			...
			?>
			  ...
			  <?php } ?>                         
						   ...
						   <div class='alert alert-info'> Data otomatis diperbaharui setiap 10 detik.</div>
                                </div>
                            </div>
                            <!-- [ Main Content ] end -->
							 <center>
<span style='color:white'><i class='feather icon-bookmark'></i><?php echo $data->kode;?></span>
	...
	<script>
	 ...
	 {	   $("#mdl_formSubmit").modal();
			 ...
			 $.post("<?php echo site_url("welcome/add_bahan_rakor"); ?>",{kode:kode,sts:1},function(data){
		 	   $("#editan").html(data);
	...
	<script>
	 ...
	 {	   			$("#mdl_formSubmit").modal();
		 		     $("#peserta").html(cantik());
			 var kode = "<?php echo $kode;?>";
			 $.post("<?php echo site_url("welcome/edit_bahan_rakor"); ?>",{id:id,kode:kode,sts:1},function(data){
		 	   $("#editan").html(data);
...
setInterval(function(){ reload_table(); }, 10000);
...
function getStatus()
{
  ...
  var  dataTable = $('#table').DataTable({ 
	...
	function updateRekap()
	 ...
	 $.ajax({
		 url:"<?php echo base_url()?>welcome/updateRekapAll",
		 data: {kode:kode},
		 method:"POST",
		 dataType:"JSON",
		 beforeSend: function() {
