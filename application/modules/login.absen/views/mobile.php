...
<title>Login - Absensi PJLP</title>
...
<body class="theme-blue" data-highlight="green2">
...
<div class="page-title page-title-large">
	<h2 data-username="" class="text-white text-center">  ABSENSI PJLP</h2>
</div>
 
<center><h1><img width='200px' style="border-radius:25px" src="<?= base_url('landingpage/loggo.png');?>"></h1>
<br>
</center>
...
<form action="javascript:login()" method="POST" id="formlogin">
	...
	<div class="card card-style">
		<div class="content mt-2 mb-0">
			...
			<div class="input-style has-icon input-style-1 input-required pb-1 ipt_pass">
			<a href="#">	<i class="input-icon fa fa-lock color-theme"></i> </a>
				<span>Password</span>
				<em>(required)</em>
				<input type="password" name="password" required placeholder="Password">
			</div>
			<button class="btn btn-m mt-2 mb-1 btn-block bg-green2-dark rounded-sm text-uppercase font-900">Masuk</button>
<center>- or - </center>
 
    <a class="oauth-container   darken-4 white black-text" href="<?=$login_button;?>" style="text-transform:none">
        <div class="left ">
            <img  style="width:100%" alt="Google sign-in" 
                src="<?=base_url()?>plug/img/button-gmail.png" />
    </a>
	<br/>
	<br/>
...
if($err){
    echo '<div  class="alert alert-warning">Akun google anda belum ditautkan, untuk menautkan
    silahkan login terlebih dahulu dengan username & password kemudian pilih menu profile.</div>';
}
?>
