 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title">Data akun admin
					 ...
					 "processing": ' <span class="sr-only dataTables_processing">Loading...</span> <br><b style="color:black;background:white">Proses menampilkan data<br> Mohon Menunggu..</b>',
						...
						"sInfo": "Total :  _TOTAL_ , Halaman (_START_ - _END_)",
						 "sInfoEmpty": "Tidak ada data yang di tampilkan",
						   "sZeroRecords": "Data akun baru tidak tersedia",
...
function add()
{
 ...
 <div class="modal fade" id="mdl_modal_artikel" tabindex="-1" role="dialog">
	...
	<form  action="javascript:submitFormAkun('modal_artikel')" id="modal_artikel" url="<?php echo base_url()?>akun/insert/12"   method="post" enctype="multipart/form-data">
