	...
	<table style="width:90%;  margin-left: auto; margin-right: auto; border-collapse: separate; border-spacing: 0px;">
		...
		<tr>
			<td colspan="4">
				...
				<!-- <small>SARS-CoV 2 Rapid Molecular Assay</small> -->
			</td>
		</tr>
...
<div style="width: 90%; margin-left: auto; margin-right: auto;">
		<p>Catatan : - Hasil negatif dapat ditemukan pada infeksi SARS-CoV-2 dengan kadar antigen di bawah batas deteksi alat. Disarankan melakukan konfirmasi dengan pemeriksaan RT-PCR sesuai rekomendasi dokter dan kondisi klinis. 
			<br>Note : - Negative result can be found in SARS-CoV-2 infection with antigen level below the detection limit of test instrument. It is advisable to do confirmatory RT-PCR examination according to doctor's recommendation and clinical condition.</p>
	</div>
