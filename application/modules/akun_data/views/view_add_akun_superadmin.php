...
<div class="modal-content">  
	...
	<div class="modal-body" >
		...
		<form  action="javascript:submitForm('modal_edit')" id="modal_edit" url="<?php echo base_url()?>akun_data/insert_akun_superadmin"  method="post" enctype="multipart/form-data">
