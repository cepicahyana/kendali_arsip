...
<script type="text/javascript">
	function hapus(id,akun){
		...
		swal({
			...
			if (willDelete) {
				...
				var url   = "<?php echo site_url("akun_data/hapus_akun_admin");?>";
      ...
      var  dataTable = $('#table').DataTable({ 
        ...
        "ajax": {
        	"url": "<?php echo site_url('akun_data/get_data_admin');?>",
        	"type": "POST",
        	"data": function ( data ) {
    ...
    <script>
      ...
      function add()
      {
        var url   = "<?php echo site_url("akun_data/add_akun_admin");?>";
      ...
      function edit(id)
      {	 
        var url   = "<?php echo site_url("akun_data/edit_akun_admin");?>";
        var param = {<?php echo $this->m_reff->tokenName()?>:token,id:id};
        $.ajax({
         type: "POST",dataType: "json",data: param, url: url,
         success: function(val){
