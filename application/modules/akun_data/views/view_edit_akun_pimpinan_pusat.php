...
<div class="modal-content">  
	...
	<div class="modal-body" >
		...
		<form  action="javascript:submitForm('modal_edit')" id="modal_edit" url="<?php echo base_url()?>akun_data/update_akun_pimpinan_pusat"  method="post" enctype="multipart/form-data">
