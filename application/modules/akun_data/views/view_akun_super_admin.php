						...
						<div>
							...
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Akun Superadmin</li>
								</ol>
							</nav>
						</div>
	 </div>
...
<script type="text/javascript">
	function hapus(id,akun){
		...
		swal({
			...
			if (willDelete) {
				...
				var url   = "<?php echo site_url("akun_data/hapus_akun_superadmin");?>";
      ...
      var  dataTable = $('#table').DataTable({ 
        ...
        "ajax": {
        	"url": "<?php echo site_url('akun_data/get_data_superadmin');?>",
        	"type": "POST",
        	"data": function ( data ) {
    ...
    <script>
      ...
      function add()
      {
        var url   = "<?php echo site_url("akun_data/add_akun_superadmin");?>";
      ...
      function edit(id)
      {	 
        var url   = "<?php echo site_url("akun_data/edit_akun_superadmin");?>";
        var param = {<?php echo $this->m_reff->tokenName()?>:token,id:id};
        $.ajax({
         type: "POST",dataType: "json",data: param, url: url,
         success: function(val){
