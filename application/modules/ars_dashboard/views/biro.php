			...
			<table id='table' width="100%" class="tabel black table-striped table-bordered table-hover dataTable">
				<thead>
					<tr>
						...
						<th class='thead' >NAMA BIRO</th>  
						<th class='thead' >DEPUTI</th>  
						<!-- <th class='thead' >POSITIF COVID </th>	  
						<th class='thead' >NEGATIF COVID </th>	   -->
...
<script type="text/javascript">
	function hapus(id,akun){
		...
		swal({
			...
			if (willDelete) {
				...
				var url   = "<?php echo site_url("data_master/hapus_biro");?>";
      ...
      var  dataTable = $('#table').DataTable({ 
        ...
        "ajax": {
        	"url": "<?php echo site_url('data_master/getData_biro');?>",
        	"type": "POST",
        	"data": function ( data ) {
    ...
    <script>
     function add()
     {
      var url   = "<?php echo site_url("data_master/viewAdd_biro");?>";
    ...
    {	 
      ...
      var url   = "<?php echo site_url("data_master/viewEdit_biro");?>";
      var param = {<?php echo $this->m_reff->tokenName()?>:token,id:id};
      $.ajax({
       type: "POST",dataType: "json",data: param, url: url,
       success: function(val){
