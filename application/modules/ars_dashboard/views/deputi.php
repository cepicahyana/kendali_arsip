	...
	<div>
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">deputi</li>
			</ol>
		</nav>
	</div>
</div>
...
<script type="text/javascript">
	function hapus(id,akun){
		...
		swal({
			...
			if (willDelete) {
				...
				var url   = "<?php echo site_url("data_master/hapus_deputi");?>";
      ...
      var  dataTable = $('#table').DataTable({ 
        ...
        "ajax": {
        	"url": "<?php echo site_url('data_master/getData_deputi');?>",
        	"type": "POST",
        	"data": function ( data ) {
    ...
    <script>
     function add()
     {
      var url   = "<?php echo site_url("data_master/viewAdd_deputi");?>";
    ...
    {	 
      ...
      var url   = "<?php echo site_url("data_master/viewEdit_deputi");?>";
      var param = {<?php echo $this->m_reff->tokenName()?>:token,id:id};
      $.ajax({
       type: "POST",dataType: "json",data: param, url: url,
       success: function(val){
