<div class="pd-5 pd-sm-5 bg-gray-100" style="border-radius:3px">
...
<div class="col-md-6 col-lg-6">
								<div class="card">
									<div class="pt-4 pb-0" style="margin-left:20px">
										<div class="d-flex justify-content-between">
											<h4 class="card-title mg-b-10 "><i class="fa fa-archive"></i> ARSIP</h4>
										</div>
									</div>
									<div class="p-4">
										<div class="">
											<div class="row">
												<div class="col-md-6 col-6 text-center">
													<div class="task-box info mb-0">
														<p class="mb-0 tx-12">Belum diberkas</p>
														<h3 class="mb-0">385</h3>
													</div>
												</div>
												<div class="col-md-6 col-6 text-center">
													<div class="task-box success  mb-0">
														<p class="mb-0 tx-12">Sudah diberkas</p>
														<h3 class="mb-0">19</h3>
													</div>
												</div>
											</div>
									...
									<div class="task-stat pb-0">
										<div class="d-flex tasks">
											<div class="mb-0">
												<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-primary me-2"></i>Konvensional</div>
												<span class="text-muted tx-11 ms-4"> </span>
											</div>
											<span class="float-end ms-auto">135</span>
										</div>
										<div class="d-flex tasks">
											<div class="mb-0">
												<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-pink me-2"></i>Elektronik</div>
												<span class="text-muted tx-11 ms-4"> </span>
											</div>
										...
										<div class="d-flex tasks">
											<div class="mb-0">
												<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-success me-2"></i>Audio visual</div>
												<span class="text-muted tx-11 ms-4"> </span>
											</div>
					...
					<div class="col-lg-6 col-md-12">
						<div class="card">
							<div class="card-body">
								<div>
									<h6 class="card-title mb-1"><i class="fa fa-folder"></i> ARSIP</h6>
								</div>
								...
								<table class="table table-hover table-bordered mb-0 text-md-nowrap text-lg-nowrap text-xl-nowrap  ">
												...
												<tbody>
													<tr>
														<td>
															<div class="project-names">
																<h6 class="badge bg-info">ACTIVE</h6>
															</div>
														</td>
														<td>
															<div  >1200</div>
													...
													<tr>
														<td>
															<div class="project-names">
																<h6 class="badge bg-primary">IN-ACTIVE</h6>
															</div>
														</td>
														<td>
															<div >202</div>
													...
													<tr>
														<td>
															<div class="project-names">
																<h6 class="badge bg-danger">MASA RETENSI HABIS</h6>
															</div>
														</td>
														<td>
															<div  >345</div>
