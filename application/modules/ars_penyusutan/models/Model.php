    ...
    function _getData_pemindahan()
    {
        ...
        if (strlen(isset($_POST['search']['value']) ? ($_POST['search']['value']) : null) > 1) {
            ...
            $query = array(
                "kode" => $searchkey,
                "nomor" => $searchkey,
                "dari_organisasi_kode" => $searchkey,
                "tujuan_organisasi_kode" => $searchkey,
                "tipe" => $searchkey,
                "tanggal" => $searchkey,
            );
            $this->db->group_start()
        ...
        $query = $this->db->from("ars_trx_pemindahan");
        return $query;
    }
