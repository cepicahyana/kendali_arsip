					...
					<table id='tableItemArsip' width="100%" class="tabel black table-striped table-bordered table-hover dataTable">
						...
						<!-- <tfoot>
							<tr>
								<th colspan="5">
									<div align="right">
										<button type="button" role="button" id="btnAddArchive" class="btn btn-success"><i class='fa fa-plus'></i> Arsip Usul Musnah</button>
									</div>
								</th>
							</tr>
						</tfoot> -->
				...
				<div class="col-xl-5 col-lg-12">
					...
					<!-- <div class="row row-xs mg-b-20 align-items-center">
                        ...
                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                            <input class="form-control text-black" name="f[nomor]" placeholder="Nomor..." type="text" value="">
                        </div>
                    </div> -->
					<div class="row row-xs mg-b-20 align-items-center">
						<div class="col-md-4">
						...
						<div class="col-md-8 mg-t-5 mg-md-t-0">
							<input class="form-control text-black" name="f[tanggal]" placeholder="Tanggal Pemusnahan..." type="date" value="">
						</div>
					</div>
					<div class="row row-xs mg-b-20 align-items-center">
						<div class="col-md-4">
						...
						<div class="col-md-8 mg-t-5 mg-md-t-0">
							<select class="form-control select2" name="f[tim]" data-placeholder="Tim Pemusnahan..." multiple>
					...
					<div class="row row-xs mg-b-20 align-items-center">
						...
						<div class="col-md-8 mg-t-5 mg-md-t-0">
							<input class="form-control text-black" name="f[nomor]" placeholder="SK Tim Pemusnahan..." type="file" value="">
						</div>
					</div>
