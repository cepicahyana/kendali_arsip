...
<div class="card">
	<div class="row card-body" style='padding-top:10px;padding-bottom:20px'>
		<form action="<?php echo base_url() ?>ars_penyusutan/pemusnahan/update_form_penilaian_anri" id="form-pemusnahan" url="<?php echo base_url() ?>ars_penyusutan/pemusnahan/update_form_penilaian_anri" method="post" enctype="multipart/form-data">
					...
					<div class="border">
						<div class="bg-gray-300 nav-bg">
							<nav class="nav nav-tabs">
								<a class="nav-link active" data-bs-toggle="tab" href="#tab_usulmusnah_anri">Usul Musnah</a>
								<a class="nav-link" data-bs-toggle="tab" href="#tab_ditangguhkan_anri">Tangguhkan</a>
							</nav>
						</div>

						<div class="card-body tab-content">
							<div class="tab-pane active show" id="tab_usulmusnah_anri">
							...
							<div class="tab-pane" id="tab_ditangguhkan_anri">
								<div class="col-md-12" id="area_lod">
									<h5>Arsip yang akan Dimusnahkan</h5>
									<hr class="mt-1">
									<table id='table_ditangguhkan_anri' width="100%" class="tabel black table-striped table-bordered table-hover dataTable">
										<thead>
											<tr>
												<th class='thread' width='15px'>Pilih</th>
												<th class='thread'>Klasifikasi</th>
				...
				<div class="col-xl-5 col-lg-12">
					...
					<div class="row row-xs mg-b-20 align-items-center">
						...
						<div class="col-md-8 mg-t-5 mg-md-t-0">
							<input class="form-control text-black" name="attach_sk_penilaian_anri" placeholder="SK Penilaian Tim Pemusnahan..." type="file" value="">
						</div>
					</div>
...
<script type="text/javascript">
	...
	var dataTable_ditangguhkan_anri = $('#table_ditangguhkan_anri').DataTable({
		"paging": true,
		"processing": false,
		"ordering": false,
		"language": {
...
<script>
	function pilihBerkas(ini) {
		...
		$.ajax({
			...
			success: function(data) {
				dataTable_usulmusnah_anri.ajax.reload();
				dataTable_ditangguhkan_anri.ajax.reload();
	...
	$('#form-pemusnahan').submit(function(e) {
		...
		$("#mdl_modal").modal("show");
		$("#response").html(cantik());
		var url = "<?php echo site_url('ars_penyusutan/pemusnahan/update_form_penilaian_anri'); ?>";
