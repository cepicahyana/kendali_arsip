...
$id_kab = isset($peg->id_kab)?($peg->id_kab):null; //for get kabupaten
$no_hp = isset($query->no_hp)?($query->no_hp):null;
$kode_istana = isset($peg->kode_istana)?($peg->kode_istana):null;
$istana = $this->m_reff->istana($kode_istana);
$kode_biro = isset($peg->kode_biro)?($peg->kode_biro):null;
