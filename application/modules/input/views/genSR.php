...
$istana = isset($query->kode_istana)?($query->kode_istana):null;
$nama_istana = $this->m_reff->goField("tr_istana","istana","where kode='".$istana."'");
...
$header    =  $this->m_reff->goField("tr_istana","header","where kode='".$istana."'");
...
?>
        ...
        <p class="text" align="right"><?php echo str_replace("Istana Kepresidenan","",$nama_istana);?>, <?php echo date('d-m-Y')?><p>
		...
		<table  class="table">
			...
			<tr>
				<td>Jenis tes</td>
				<td width="525"> : <?php echo $jenis_test?></td>
			</tr>
		</table>
		<br>
		<table width="625"  class="table">
