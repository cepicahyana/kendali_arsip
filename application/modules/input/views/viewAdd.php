...
<input type="hidden" id="formToken" name="<?php echo $this->m_reff->tokenName()?>" value="<?php echo $this->m_reff->getToken()?>">
								...
								<div class=" pd-sm-20 "  >
									...
									<div class="row row-xs align-items-center mg-b-20">
										...
										Input   NIP
											<input autocomplete="off"  class="form-control" name="input"  placeholder="ketik..." type="text">
...
<div class="row row-xs align-items-center mg-b-20">
 									 ...
 									 <input type="text"   name="tgl_test" id="tgl" class="form-control">
										</div>
   </div>
...
<div class="row row-xs align-items-center mg-b-20">
   ...
   <div class="row row-xs align-items-center mg-b-20">
									...
									echo form_dropdown("f[id_keperluan]",$op,null,"required onchange='keperluan(this.value)' class='form-control' style='color:black'"); 
							 	?>
										</div>
   </div>
   <!-- <div class="row row-xs align-items-center mg-b-20">
										<div class="col-md-4">
											<label class="black form-label mg-b-0" style='color:black'>Keperluan test</label>
								                </div>
										<div class="col-md-8 mg-t-5 mg-md-t-0">
 									<input value="Keperluan pekerjaan"  type="text" name="f[keperluan]" class="form-control">
										</div>
   </div> -->
...
<script>
	function setNIK(id,nik){
	 
		// loading("area_modal");
		var url   = "<?php echo site_url("input/setNIK");?>";
