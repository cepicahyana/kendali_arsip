    ...
    <div class="col-md-12">
        ...
        <div class="card-block">
            <h5 class="sub-title">Edit    </h5><hr>
                <div class="row">
                    <div class="col-md-12">
                        <form id="formSubmit" action="javascript:submitForm('formSubmit')" method="post" url="<?php echo site_url()?>akun_ppnpn/update_akun_pimpinan">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label" for="owner">Nama</label>
                            <div class="col-sm-8">
