...
var save_method; //for save method string
      ...
      var  dataTable = $('#table').DataTable({ 
        ...
        "ajax": {
        	"url": "<?php echo site_url('akun_ppnpn/get_data_pic');?>",
        	"type": "POST",
        	"data": function ( data ) {
    ...
    function add()
    {
        var url   = "<?php echo site_url("akun_ppnpn/add_akun_pic");?>";
    ...
    function edit(id)
    {	 
        var url   = "<?php echo site_url("akun_ppnpn/view_edit_akun_pic");?>";
    ...
    function hapus(id, nama) {
 		alertify.confirm("<center> Hapus  <br>" + nama + " ?</center>", function() {
            var url   = "<?php echo site_url("akun_ppnpn/hapus_akun_pic");?>";
            var param = {<?php echo $this->m_reff->tokenName()?>:token,id:id};
            $.ajax({
                type: "POST",dataType: "json",data: param, url: url,
                success: function(val){
