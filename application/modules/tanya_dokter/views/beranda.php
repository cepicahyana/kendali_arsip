            ...
            <div class="card">
							...
							<div class="card-body">
								<form>
									...
									<div class="form-group">
										<div class="row ">
											<label class="col-sm-12">Apa yang anda rasakan ?</label>
											<div class="col-sm-12">
...
function getNewReplay(){
                            var url   = "<?php echo site_url("tanya_dokter/getNewReplay");?>";
...
function reload_status(){ 
    ...
    var load = loading("shareInfo");
	  $("#shareInfo").html(load);
	  var url   = "<?php echo site_url("tanya_dokter/reload_status");?>";
							var param = {<?php echo $this->m_reff->tokenName()?>:token};
							$.ajax({
									type: "POST",dataType: "json",data: param, url: url,
									success: function(val){
 ...
 function kirim_status(){
                            ...
                            var url   = "<?php echo site_url("tanya_dokter/kirim_status");?>";
 ...
 function kirim_balasan(){
	 ...
	 var msg = $("[name='msg_balasan']").val();
                            ...
                            var url   = "<?php echo site_url("tanya_dokter/kirim_balasan");?>";
 ...
 function lihat_obrolan(id){
                            var url   = "<?php echo site_url("tanya_dokter/lihat_obrolan");?>";
...
//  }
 ...
 function hapus_sts(id){
		  ...
		  swal({
							...
							var url   = "<?php echo site_url("tanya_dokter/hapus_status");?>";
							var param = {id:id,<?php echo $this->m_reff->tokenName()?>:token};
							$.ajax({
									type: "POST",dataType: "json",data: param, url: url,
									success: function(val){
 ...
 function akhiri(id){
		  ...
		  swal({
							...
							var url   = "<?php echo site_url("tanya_dokter/akhiri_obrolan");?>";
							var param = {id:id,<?php echo $this->m_reff->tokenName()?>:token};
                            loading("shareInfo");
							$.ajax({
									type: "POST",dataType: "json",data: param, url: url,
 ...
 function hapus_com(id){
     ...
     swal({
							...
							var url   = "<?php echo site_url("tanya_dokter/hapus_com");?>";
							var param = {id:id,<?php echo $this->m_reff->tokenName()?>:token};
							$.ajax({
									type: "POST",dataType: "json",data: param, url: url,
									success: function(val){
