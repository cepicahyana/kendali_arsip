		...
		<li><a class='link'  id="kepala" href='#'>
			...
			<ul> 
				<li>
				 ...
				 <li>
					<a class='link' id="kepala" href='#'><b>Kepala Subbagian <br>Penyiapan Sarana Acara dan  
						 Upacara</b>
					<br>
					<?php echo $this->mdl->pejabat("kepala Subbagian Penyiapan Sarana Acara dan Upacara"); ?>
				</a>
				<ul>
					...
					<li style="margin-top:-20px">
						<div class="group" style="margin-top:20px">
							...
							$data=array(
								...
								"bagian"=>"Bagian Peralatan dan Penataan Lingkungan",
								"subbagian"=>"Subbagian Penyiapan Sarana Acara dan Upacara",
								"biro"=>"03",
							); 
			...
			<li>
				...
				<a class='link pb5' href='#' id="kepala">
					<b>Kepala Subbagian Peralatan Rumah</b><br>
							<b>Tangga dan Linen</b>
							<br>
							<?php echo $this->mdl->pejabat("kepala Subbagian Peralatan Rumah Tangga dan Linen"); ?>
				</a>
				<ul>
					<li style="margin-top:-20px">
						<div class="group" style="margin-top:20px">
							...
							$data=array(
								"jabatan"=>"Pengelola Sarana dan Prasarana Kantor",
								"bagian"=>"Bagian Peralatan dan Penataan Lingkungan",
								"subbagian"=>"Subbagian Peralatan Rumah Tangga dan Linen",
								"biro"=>"03",
							); 
							echo $this->mdl->jenjang_jabatan($data);
								?> 
			...
			<li>
				...
				<a class='link' id="kepala" href='#'>
					<b>Kepala Subbagian Penataan dan </b><br>
						<b>Pemeliharaan Lingkungan</b>	
						<br>	
						<?php echo $this->mdl->pejabat("kepala Subbagian Penataan dan Pemeliharaan Lingkungan"); ?>		
				</a>
					...
					<li style="margin-top:-20px">
						...
						<?php
							$data=array(
								...
								"bagian"=>"Bagian Peralatan dan Penataan Lingkungan",
								"subbagian"=>"Subbagian Penataan dan Pemeliharaan Lingkungan",
								"biro"=>"03",
							); 
							echo $this->mdl->jenjang_jabatan($data);
								?> 
