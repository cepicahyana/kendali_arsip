		 ...
		 ?>
			 ...
			 <ul> 
				 <li>
					...
					<?php 
					$data = array(
						"jabatan" =>"DEPUTI BIDANG ADMINISTRASI DAN PENGELOLAAN ISTANA",
					);
					echo $this->mdl->pejabat($data); ?>			
				</a>
				...
				<ul>
					<li>
						...
						<a class='link pb5' href='#' id="kepala">
							...
							<?php 
							$data = array(
								"jabatan" =>"KEPALA ISTANA KEPRESIDENAN BOGOR",
								"kode_istana" =>"05",
							);
							echo $this->mdl->pejabat($data); 
							?>
						...
						<ul>
							...
							echo $this->mdl->pejabat($data); ?>
								...
								<a class='link block9' href='#'>
									...
									<?php 
							$data = array(
								"jabatan" =>"KEPALA Subbagian rumah tangga dan protokol",
								"kode_istana" =>"05",
							);
							echo $this->mdl->pejabat($data); ?>
								</a><br><br>
								...
								<a class='link block9' href='#'>
									...
									<?php 
							$data = array(
								"jabatan" =>"KEPALA Subbagian bangunan",
								"kode_istana" =>"05",
							);
							echo $this->mdl->pejabat($data); ?></a><br><br><br>
					...
					<li>
						...
						<a class='link pb5' href='#' id="kepala">
							...
							<?php
							$data = array(
								"jabatan" => "KEPALA  istana kepresidenan cipanas",
								// "kode_istana"=>"02",
							);
							echo $this->mdl->pejabat($data);
							?>
					...
					<li>
						...
						<a class='link pb5' href='#' id="kepala">
							<b>KEPALA ISTANA KEPRESIDENAN</b> <br> 
									<b>YOGYAKARTA </b>
							<br> 
							<?php echo $this->mdl->pejabat("KEPALA ISTANA KEPRESIDENAN YOGYAKARTA"); ?>
						</a>
						<ul>
							<li style="margin-top:-20px">
								<div class="group" style="margin-top:20px">
					...
					<li>
						...
						<a class='link pb5' href='#' id="kepala">
							...
							<?php
									$data = array(
										"jabatan" => "KEPALA ISTANA KEPRESIDENAN BALI",
									);
									echo $this->mdl->pejabat($data);
									?>
						</a>
