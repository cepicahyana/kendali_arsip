					...
					<div class="breadcrumb-header justify-content-between">
						<div>
							<h4 class="content-title mb-2"><i class="  icon ion-md-chatboxes"></i> Riwayat obrolan pegawai dengan dokter</h4>
...
<hr>
  ...
  var  dataTable = $('#table').DataTable({ 
	  ...
	  dom: 'Blfrtip',
        ...
        "ajax": {
            "url": "<?php echo site_url('riwayat_obrolan/getData');?>",
            "type": "POST",
			"data": function ( data ) {
...
<script>
		function replay(id, msg) {
			...
			// $('#replayID').val(id);
			//replayID = id;
			var url = "<?php echo site_url("riwayat_obrolan/tanggapi"); ?>";
					var param = {
						id: id,
						msg:msg,
		...
		function akhiri(id){
			swal({
						...
						if (willDelete) {
							...
							var url = "<?php echo site_url("riwayat_obrolan/akhiri_obrolan"); ?>";
										var param = {
											id: id,
											<?php echo $this->m_reff->tokenName() ?>: token
										};
