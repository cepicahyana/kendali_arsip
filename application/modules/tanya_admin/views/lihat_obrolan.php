<div class="modal-content">  
                         <div class="modal-header">  <h5 class="modal-titles" id="defaultModalLabel"><b>Riwayat obrolan </b></h5>
...
$data	= $this->db->get("data_tanya_admin")->result();
foreach($data as $val){
?>
...
foreach($dataKomen as $kom){
    if($kom->id_sender!=$this->m_reff->idu()){
        $komentator = $this->m_reff->goField("tm_pic","nama","where id='".$kom->id_sender."' ");
        $jk_komen   = "cs".$this->m_reff->goField("tm_pic","jk","where id='".$kom->id_sender."' ");
    }else{
    ...
    <div class="media d-block d-sm-flex mg-t-25">
			<img alt="s" class='mundurImg' align="left" src="<?php echo base_url()?>assets/<?= $jk_komen ?>.png">
			<div class="media-body">
