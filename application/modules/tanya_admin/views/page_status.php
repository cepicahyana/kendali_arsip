...
<div class="align-self ml-auto" >
 <a  class="bg-warning akhiri-obrolan" style="color:black;padding:2px;border-radius:20px;float:right"  
 onclick="lihat_obrolan(`<?php echo $val->id;?>'`)"   href="javascript:void(0)"  > <span class="text-info"></span>   <i class="typcn typcn-arrow-forward-outline"></i> 
