...
$nip          = $db->nip_pegawai;
$kode_istana  =   $db->kode_istana;
$kode_biro    =   $db->kode_biro;
$nik          = $db->nik;
...
<?php  }else{?>          
    <form  action="javascript:submitForm('modal')" 
					id="modal" url="<?php echo base_url()?>monkes/ajukan_tes_keluarga"  method="post" enctype="multipart/form-data">
 ...
 <input type="hidden" name="f[kode_istana]" value="<?php echo  $kode_istana;?>">
 <input type="hidden" name="f[kode_biro]" value="<?php echo  $kode_biro;?>">
 <input type="hidden" id="formToken" name="<?php echo $this->m_reff->tokenName()?>" value="<?php echo $this->m_reff->getToken()?>">
 <div class="row row-xs align-items-center mg-b-20"> <div class="col-md-4">
...
<button class="btn btn-success" onclick="submitForm('modal')"> Ajukan sekarang</button>
</center>
