...
$penularan  = str_replace("[","",$tes->penularan); 
...
<div class="col-lg-12  col-md-12 col-sm-12">
								<div class="card card-dashboard-events">
                                    ...
                                    <div class="border list-group">
                                        ...
                                        $db = $this->db->get("data_kondisi")->result();
                                        $i=1;
                                        $kondisi_akhir="";
                                        foreach($db as $val){
...
';
										...
										<div class="tab-pane p-2" id="tabCont3">
                                            <?php
                                            $dp = $this->m_reff->data_pegawai($tes->nik);
                                            if($dp->kode_biro){
                                                $biro = $this->m_reff->goField("tr_biro","biro","where kode='".$dp->kode_biro."' ");
                                            }else{
                                                $biro = $this->m_reff->goField("tr_istana","istana","where kode='".$dp->kode_istana."' ");
                                            }
										...
										<div class="tab-pane p-2" id="tabCont4">
                                         ...
                                         <div class="tab-pane p-2" id="tabTes">
                                           <?php
                                           $tbl   = ""; $no=1;
                                                    $this->db->where("nik",$dp->nik);
                                           $dbpeg = $this->db->get("data_test")->result();
                                           foreach($dbpeg as $val){
                                               if($val->hasil=="+"){
                                                ...
                                                <td>".$this->m_reff->goField("tm_rs","nama","where kode='".$val->kode_tempat."'")."</td>
                                                <td>".$hasil."</td>
                                                </tr>
                                                ";
                                           }
