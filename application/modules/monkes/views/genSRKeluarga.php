...
$header    =  $this->m_reff->goField("tr_istana","header","where istana='".$kode_istana."'");
...
?>
        ...
        <p class="text" align="right"><?php echo str_replace("Istana Kepresidenan","",$kode_istana);?>, <?php echo date('d-m-Y')?><p>
		...
		<table width="625"  class="table">
			<tr>
				<td><img src="<?=$qr?>" style="float:left;width:100px;height:100px;"></td>
