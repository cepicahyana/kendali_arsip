...
?>
					...
					<div class="breadcrumb-header justify-content-between">
						<div>
							<h4 class="content-title mb-2">Notifikasi Permohonan Tes Peserta External</h4>
                    ...
                    <form id="formSubmit" action="javascript:submitFormNoResset('formSubmit')" method="post" url="<?php echo site_url('notifikasi/update');?>" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6" style="padding:20px">
                            ...
                            {email}   =   Alamat email peserta tes<br>
                            {tgl_tes}   =   Tanggal tes <br>
                            {tempat_tes} =  Rumah sakit tempat tes<br>
                            {kode_tes} = Kode tes<br>
                            {awalan} = Nama awalan/sapaan (Bpk/Ibu)<br>
