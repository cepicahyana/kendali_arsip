...
?>
					...
					<div class="breadcrumb-header justify-content-between">
						<div>
							<h4 class="content-title mb-2">Notifikasi Permohonan Tes</h4>
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#"> Notifikasi permohonan tes telah disetujui</a></li>
                    ...
                    <form id="formSubmit" action="javascript:submitFormNoResset('formSubmit')" method="post" url="<?php echo site_url('notifikasi/update');?>" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6" style="padding:20px">
                            ...
                            {nik}   =   Nomor Induk Penduduk Peserta Tes<br>
                            {rs}   =   Rumah sakit tempat tes<br>
                            {tgl_tes}   =   Tanggal tes keluar<br>
                            {kode}   =   Kode tes<br>
                            {awalan}   =   Awalan panggilan (Bpk/Ibu)<br>
                            {status}   =   ASN / PPNPN / Keluarga pegawai<br> 
                            <!-- <b>Tambahan untuk keluarga :</b><br>
                            {nama_keluarga} = Nama keluarga yang melakukan tes<br>
                            {awalan_keluarga} = Nama awalan (Bpk/ibu) keluarga yang melakukan tes<br> -->
