...
<script type="text/javascript">
	function hapus(id,akun){
		...
		swal({
			...
			if (willDelete) {
				...
				var url   = "<?php echo site_url("data_master/hapus_pegawai");?>";
      ...
      var  dataTable = $('#table').DataTable({ 
        ...
        "ajax": {
        	"url": "<?php echo site_url('data_master/getData_pegawai');?>",
        	"type": "POST",
        	"data": function ( data ) {
  ...
  <script>
  	function add()
  	{
  		$.post("<?php echo site_url("data_master/viewAdd_pegawai"); ?>",{},function(data){
  	...
  	{	 
  		...
  		$.post("<?php echo site_url("data_master/viewEdit_pegawai"); ?>",{id:id},function(data){
  			$("#editan").html(data);
  			$("#mdl_modal_edit").modal();
  		}); 
  	}
