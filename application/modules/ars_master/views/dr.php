...
<script type="text/javascript">
	function hapus(id,akun){
		...
		swal({
			...
			if (willDelete) {
				...
				var url   = "<?php echo site_url("data_master/hapus_dr");?>";
      ...
      var  dataTable = $('#table').DataTable({ 
        ...
        "ajax": {
        	"url": "<?php echo site_url('data_master/getData_dr');?>",
        	"type": "POST",
        	"data": function ( data ) {
    ...
    <script>
      ...
      function add()
      {
        var url   = "<?php echo site_url("data_master/viewAdd_dr");?>";
      ...
      function edit(id)
      {	 
        var url   = "<?php echo site_url("data_master/viewEdit_dr");?>";
        var param = {<?php echo $this->m_reff->tokenName()?>:token,id:id};
        $.ajax({
         type: "POST",dataType: "json",data: param, url: url,
         success: function(val){
