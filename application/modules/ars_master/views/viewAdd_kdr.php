...
<div class="modal-content">  
	...
	<div class="modal-body" >
		...
		<form  action="javascript:submitForm('modal_edit')" id="modal_edit" url="<?php echo base_url()?>data_master/insert_kdr"  method="post" enctype="multipart/form-data">
			...
			<div class=" pd-sm-20 "  >
				...
				<div class="row row-xs align-items-center mg-b-20">
					...
					<div class="col-md-8 mg-t-5 mg-md-t-0">
						<input class="form-control"   name='f[telp]'  placeholder="telp" type="text">
					</div>
				</div>
				<div class="row row-xs align-items-center mg-b-20">
					<div class="col-md-4">
					...
					<div class="col-md-8 mg-t-5 mg-md-t-0">
						<input class="form-control"   name='f[email]'   placeholder="email" type="email">
					</div>
				</div>
