...
$data = $this->db->get_where("data_deputi",array("id"=>$id))->row();
$kode = $data->kode;
$nama = $data->deputi;
?>
<div class="modal-content">  
	...
	<div class="modal-body" >
		...
		<form  action="javascript:submitForm('modal_edit')" id="modal_edit" url="<?php echo base_url()?>data_master/update_deputi"  method="post" enctype="multipart/form-data">
			...
			<div class=" pd-sm-20 "  >
				...
				<div class="row row-xs align-items-center mg-b-20">
					...
					<div class="col-md-8 mg-t-5 mg-md-t-0">
						<input class="form-control" required name='f[deputi]' value="<?php echo $nama?>" placeholder="nama biro" type="text">
					</div>
				</div>
