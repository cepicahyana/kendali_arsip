...
<div class="modal-content">  
	...
	<div class="modal-body" >
		...
		<form  action="javascript:submitForm('modal_edit')" id="modal_edit" url="<?php echo base_url()?>data_master/update_pic"  method="post" enctype="multipart/form-data">
			...
			<div class="row row-xs align-items-center mg-b-20">
                ...
                <div <?= (strtolower($id_istana) == $this->m_reff->pengaturan(2)) ? '': 'hidden'; ?> id="dataBiro" class="row row-xs align-items-center mg-b-20">
					<div class="col-md-4">
...
function dataBiro(id) {
	...
	document.getElementById("inputGroupSelect05").required = true;
	}else {
	$("#dataBiro").attr("hidden",true);
	document.getElementById("inputGroupSelect05").required = false;
	}
}
</script>