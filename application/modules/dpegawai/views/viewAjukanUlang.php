...
<div class="modal-content">  
                         <div class="modal-header">  <h5 class="modal-titles" id="defaultModalLabel"><b>Ajukan permohonan tes covid untuk anda sendiri. </b></h5>
...
<?php  }else{?>          
    <form  action="javascript:submitForm('modal_kondisi')" 
					id="modal_kondisi" url="<?php echo base_url()?>dpegawai/ajukan_tes"  method="post" enctype="multipart/form-data">
