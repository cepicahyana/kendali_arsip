...
<form  action="javascript:submitForm('modal')" id="modal" url="<?php echo base_url()?>input_permohonan/insert_family"  method="post" enctype="multipart/form-data">
...
function getDataByNik(val){
    var url   = "<?php echo site_url("input_permohonan/getDataKeluarga");?>";
