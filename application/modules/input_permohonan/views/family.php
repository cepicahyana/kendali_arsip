					...
					<div class="breadcrumb-header justify-content-between">
						<div>
							<h4 class="content-title mb-2">Input anggota keluarga </h4>
		 ...
		 <i class='fa fa-edit'></i> INPUT DATA KELUARGA YANG AKAN DITEST</button>
  ...
  var  dataTable = $('#table').DataTable({ 
	  ...
	  dom: 'Blfrtip',
        ...
        "ajax": {
            "url": "<?php echo site_url('input_permohonan/getDataFamily');?>",
            "type": "POST",
			"data": function ( data ) {
	...
	function add(){	  
			  var url   = "<?php echo site_url("input_permohonan/viewAddFamily");?>";
	...
	function edit(id){
					 	    var url   = "<?php echo site_url("input_permohonan/viewEditFamily");?>";
	...
	function acc(id,sts,akun){
	 ...
	 swal({
					   ...
					   var url   = "<?php echo site_url("input_permohonan/setStsAccFam");?>";
