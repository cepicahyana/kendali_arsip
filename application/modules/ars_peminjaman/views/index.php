	                ...
	                <div class="border">
	                    <div class="bg-gray-300 nav-bg">
	                        <nav class="nav nav-tabs">
	                            <a class="nav-link active" data-bs-toggle="tab" href="#TabBerkasAktif">Proses peminjaman</a>
	                            <a class="nav-link" data-bs-toggle="tab" href="#TabBerkasInaktif">Proses pengembalian</a>
	                        </nav>
	                    </div>
