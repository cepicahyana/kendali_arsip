...
?>
    ...
    <div class="breadcrumb-header justify-content-between">
        <div>
            <h4 class="content-title mb-2"> DATA PNS </h4>
        ...
        <!--div class="d-flex my-auto">
            <div class=" d-flex right-page">
                <div>
                    ...
                    <i class='fa fa-edit'></i> Tambah Data Baru </button>
                </div>
            </div>
        </div-->
    </div>
...
<script type="text/javascript">
    ...
    var  dataTable = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url($get_controller.'/getPNS');?>",
            "type": "POST",
            "data": function ( data ) {
	...
	function formAdd(){
	  var url   = "<?php echo site_url($get_controller."/pns_form_add");?>";
	...
	function hapus(id,akun){
		swal({
			...
			if (willDelete) {
				...
				var url   = "<?php echo site_url($get_controller."/pns_hapus");?>";
				var param = {id:id,<?php echo $this->m_reff->tokenName()?>:token};
				$.ajax({
					type: "POST",dataType: "json",data: param, url: url,
					success: function(val){
	...
	function import_data(){
		var url = "<?php echo site_url($get_controller."/pns_import");?>";
		var param = {<?php echo $this->m_reff->tokenName()?>:token};
		$.ajax({
			type: "POST",dataType: "json",data: param, url: url,
			success: function(val){
	...
	function filter(){
		var url = "<?php echo site_url($get_controller."/pns_filter");?>";
		var param = {<?php echo $this->m_reff->tokenName()?>:token};
		$.ajax({
			type: "POST",dataType: "json",data: param, url: url,
			success: function(val){
