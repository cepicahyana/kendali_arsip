...
$action_url = (empty($id_pegawai)) ? '/cs_insert' : '/cs_update' ;
?>
<div class="modal-content">
	<div class="modal-header">  <h5 class="modal-titles" id="defaultModalLabel"><b>Tambah Data Cleaning Service</b></h5>
	...
	<div class="modal-body">
		<form  action="javascript:submitForm('modal')" id="modal" url="<?php echo site_url($get_controller.$action_url)?>"  method="post">
			...
			<div class="form-group ">
				<div class="row">
					<div class="col-md-3">
						<label class="form-label" for="nip">NIP LAMA</label>
					</div>
					<div class="col-md-9">
						<input name="f[nip]" id="nip" type="text" class="form-control" value="<?= set_value('f[nip_baru]', $nip_baru);?>">
					</div>
				</div>
			</div>
			<div class="form-group ">
			...
			<div class="form-group ">
				<div class="row">
					...
					<div class="col-md-9">
						<input name="f[email]" id="email" type="email" class="form-control" value="<?= set_value('f[email]', $email);?>" required>
					</div>
				</div>
			</div>
			<div class="form-group ">
