...
?>
    ...
    <div class="breadcrumb-header justify-content-between">
        <div>
            <h4 class="content-title mb-2"> DATA Petugas Taman </h4>
        ...
        <div class="d-flex my-auto">
            <div class=" d-flex right-page">
                <div>
                    <button onclick='import_data_pt()' class='btn btn-light' style="min-width:180px">
...
<script type="text/javascript">
    ...
    var  dataTable = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url($get_controller.'/getPetugasTaman');?>",
            "type": "POST",
            "data": function ( data ) {
	...
	function formAdd(){
	  var url   = "<?php echo site_url($get_controller."/pt_form_add");?>";
	...
	function hapus(id,akun){
		swal({
			...
			if (willDelete) {
				...
				var url   = "<?php echo site_url($get_controller."/pt_hapus");?>";
				var param = {id:id,<?php echo $this->m_reff->tokenName()?>:token};
				$.ajax({
					type: "POST",dataType: "json",data: param, url: url,
					success: function(val){
	...
	function import_data_pt(){
		var url = "<?php echo site_url($get_controller."/pt_import");?>";
		var param = {<?php echo $this->m_reff->tokenName()?>:token};
		$.ajax({
			type: "POST",dataType: "json",data: param, url: url,
			success: function(val){
