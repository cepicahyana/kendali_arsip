...
?>
    ...
    <div class="breadcrumb-header justify-content-between">
        <div>
            <h4 class="content-title mb-2"> DATA Cleaning Service </h4>
        ...
        <div class="d-flex my-auto">
            <div class=" d-flex right-page">
                <div>
                    <button onclick='import_data_cs()' class='btn btn-light' style="min-width:180px">
	    	...
	    	<div class="row">
				...
				<div class="col-md-3 mb-3">
					<?php
						...
						$db=$this->m_reff->list_bagian(4)->result();
						foreach($db as $db){
...
<script type="text/javascript">
    ...
    var  dataTable = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url($get_controller.'/getCleaningService');?>",
            "type": "POST",
            "data": function ( data ) {
	...
	function formAdd(){
	  var url   = "<?php echo site_url($get_controller."/cs_form_add");?>";
	...
	function hapus(id,akun){
		swal({
			...
			if (willDelete) {
				...
				var url   = "<?php echo site_url($get_controller."/cs_hapus");?>";
				var param = {id:id,<?php echo $this->m_reff->tokenName()?>:token};
				$.ajax({
					type: "POST",dataType: "json",data: param, url: url,
					success: function(val){
	...
	function import_data_cs(){
		var url = "<?php echo site_url($get_controller."/cs_import");?>";
		var param = {<?php echo $this->m_reff->tokenName()?>:token};
		$.ajax({
			type: "POST",dataType: "json",data: param, url: url,
			success: function(val){
