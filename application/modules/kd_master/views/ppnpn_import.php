...
<div class="modal-content">
    <div class="modal-header">  <h5 class="modal-titles" id="defaultModalLabel"><b>Import Data PPNPN</b></h5>
	...
	<div class="modal-body">
		<form  action="javascript:submitForm('modal')" id="modal" url="<?php echo site_url($get_controller.'/import_file_ppnpn')?>"  method="post" enctype="multipart/form-data">
			...
			<table class="table table-bordered mg-b-0 text-md-nowrap">
				...
				<tr>
					...
					<td>
                        ...
                        echo form_dropdown('istana', $options, null, $attr);
                        unset($options);
                        unset($attr);
                        ?>
					</td>
