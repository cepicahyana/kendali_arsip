...
<div class="modal-content">
	...
	<div class="modal-body">
		<form  action="javascript:submitForm('modal')" id="modal" url="<?php echo site_url($get_controller.'/sendBroadcast_group')?>" method="post" enctype="multipart/form-data">
				...
				<div class="col-lg-12 col-md-12">
					<div class="cards">
						<div class="card-bodys">
						    ...
						    <textarea class="form-control" name="f[wa]" style="min-height:230px"><?php echo $this->m_reff->notifikasi(2,"wa");?></textarea>
							<div>
				...
				<div class="col-md-6"><br>
				    <div class="alert alert-info">
				        ...
				        if(!$data){
				            ...
				            echo " Jumlah data yang akan dikirim  : ".$jml." Group";
				        }
				       ?>
				    </div>
				</div>
