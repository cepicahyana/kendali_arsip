...
class Model_admin extends CI_Model  {
    ...
    function insert(){
        ...
        $var["token"]=$this->m_reff->getToken();
        $this->m_reff->log("Tambah data user","data");
        return $var;
    }
    ...
    function update(){
        ...
        $var["token"]=$this->m_reff->getToken();
        $this->m_reff->log("update data user","data");
      return $var;
    }
    ...
    function cek_pass(){
        ...
        $this->db->where("username",$this->m_reff->san($this->input->post("f[username]")));
        $this->db->where("password",md5($this->m_reff->san($this->input->pos("password"))));
    ...
    function hapus(){
        $this->m_reff->log("hapus data user","data");
        $this->db->where("id_admin",$this->m_reff->san($this->input->post("id")));
