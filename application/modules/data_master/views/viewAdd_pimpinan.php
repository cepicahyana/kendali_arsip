...
<div class="modal-content">  
	...
	<div class="modal-body" >
		...
		<form  action="javascript:submitForm('modal_edit')" id="modal_edit" url="<?php echo base_url()?>data_master/insert_pimpinan"  method="post" enctype="multipart/form-data">
			...
			<div class="row row-xs align-items-center mg-b-20">
                ...
                <div id="dataBiro" class="row row-xs align-items-center mg-b-20">
					...
					<div class="col-md-8 mg-t-5 mg-md-t-0">
                        ...
                        $attr = array('class' => 'custom-select', 'id' => 'inputGroupSelect05');
