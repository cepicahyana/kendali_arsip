...
<script type="text/javascript">
	function hapus(id,akun){
		...
		swal({
			...
			if (willDelete) {
				...
				var url   = "<?php echo site_url("data_master/hapus_kdr");?>";
      ...
      var  dataTable = $('#table').DataTable({ 
        ...
        "ajax": {
        	"url": "<?php echo site_url('data_master/getData_kdr');?>",
        	"type": "POST",
        	"data": function ( data ) {
    ...
    <script>
      ...
      function add()
      {
        var url   = "<?php echo site_url("data_master/viewAdd_kdr");?>";
      ...
      function edit(id)
      {	 
        var url   = "<?php echo site_url("data_master/viewEdit_kdr");?>";
        var param = {<?php echo $this->m_reff->tokenName()?>:token,id:id};
        $.ajax({
         type: "POST",dataType: "json",data: param, url: url,
         success: function(val){
