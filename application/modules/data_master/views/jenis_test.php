	...
	<div>
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Data Jenis Test</li>
			</ol>
		</nav>
	</div>
</div>
			...
			<table id='table' width="100%" class="tabel black table-striped table-bordered table-hover dataTable">
				<thead>
					<tr>
						...
						<th class='thead' >NAMA TEST COVID</th>    
...
<script type="text/javascript">
	function hapus(id,akun){
		...
		swal({
			...
			if (willDelete) {
				...
				var url   = "<?php echo site_url("data_master/hapus_test");?>";
    ...
    var  dataTable = $('#table').DataTable({ 
        ...
        "ajax": {
        	"url": "<?php echo site_url('data_master/getData_test');?>",
        	"type": "POST",
        	"data": function ( data ) {
...
<script>
	...
	function add()
	{
		var url   = "<?php echo site_url("data_master/viewAdd_test");?>";
	...
	function edit(id)
	{	 
		var url   = "<?php echo site_url("data_master/viewEdit_test");?>";
		var param = {<?php echo $this->m_reff->tokenName()?>:token,id:id};
		$.ajax({
			type: "POST",dataType: "json",data: param, url: url,
			success: function(val){
