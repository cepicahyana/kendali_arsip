			...
			<table id='table' width="100%" class="tabel black table-striped table-bordered table-hover dataTable">
				<thead>
					<tr>
						...
						<th class='thead' >Nama Rumah Sakit</th>  
...
<script type="text/javascript">
	function hapus(id,akun){
      ...
      var  dataTable = $('#table').DataTable({ 
        ...
        "ajax": {
        	"url": "<?php echo site_url('data_master/getData_rs');?>",
        	"type": "POST",
        	"data": function ( data ) {
    ...
    <script>
      ...
      function add()
      {
        var url   = "<?php echo site_url("data_master/viewAdd_rs");?>";
      ...
      function edit(id)
      {	 
        var url   = "<?php echo site_url("data_master/viewEdit_rs");?>";
        var param = {<?php echo $this->m_reff->tokenName()?>:token,id:id};
        $.ajax({
         type: "POST",dataType: "json",data: param, url: url,
         success: function(val){
