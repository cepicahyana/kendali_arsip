...
'.$content.'
        ...
        protected function _tag_open_THEAD($param)
        {
            ...
            if ($this->_subPart) {
                ...
                HTML2PDF::$_tables[$param['num']]['tr_curr']+= count((array)HTML2PDF::$_tables[$param['num']]['thead']['tr']);
            }
        ...
        protected function _tag_open_TFOOT($param)
        {
            ...
            if ($this->_subPart) {
                ...
                $level = $this->parsingHtml->getLevel($this->_parsePos);
                $this->_parsePos+= count((array)$level);
                HTML2PDF::$_tables[$param['num']]['tr_curr']+= count((array)HTML2PDF::$_tables[$param['num']]['tfoot']['tr']);
            }
            ...
            if ($this->_subPart) {
                ...
                foreach ($lst as $mode) {
                    ...
                    foreach (HTML2PDF::$_tables[$param['num']][$mode]['tr'] as $tr) {
                        ...
                        $h = 0;
                        for ($i=0; $i<count((array)HTML2PDF::$_tables[$param['num']]['cases'][$tr]); $i++)
                ...
                for ($k=0; $k<count((array)HTML2PDF::$_tables[$param['num']]['cases']); $k++) {
                    ...
                    $th = 0;
                    $h = 0;
                    for ($i=0; $i<count((array)HTML2PDF::$_tables[$param['num']]['cases'][$k]); $i++) {
                ...
                if (count((array)HTML2PDF::$_tables[$param['num']]['tfoot']['code'])) {
                ...
                if (count((array)HTML2PDF::$_tables[$param['num']]['height'])>1)
                    $y = $this->_margeTop+HTML2PDF::$_tables[$param['num']]['height'][count((array)HTML2PDF::$_tables[$param['num']]['height'])-1];
                else if (count((array)HTML2PDF::$_tables[$param['num']]['height'])==1)
                    $y = HTML2PDF::$_tables[$param['num']]['curr_y']+HTML2PDF::$_tables[$param['num']]['height'][count((array)HTML2PDF::$_tables[$param['num']]['height'])-1];
                else
                    $y = HTML2PDF::$_tables[$param['num']]['curr_y'];
        ...
        protected function _tag_open_TR($param, $other = 'tr')
        {
            ...
            if (!$this->_subPart) {
                ...
                if (HTML2PDF::$_tables[$param['num']]['new_page'] && count((array)HTML2PDF::$_tables[$param['num']]['thead']['code'])) {
            ...
            if ($collapse) {
                if (!$this->_subPart) {
                    if (
                        ...
                        (!$this->_isInThead && count((array)HTML2PDF::$_tables[$param['num']]['thead']['code']))
                    ) {
